...
struct MIPS_Architecture {
    ...
    */
            ...
            if (mem_flag) {
                ...
                switch (instructions2[mem_op_buffer]) {
                    case 8: // sw
                        ...
                        mem_keys.push_back(alu_result / 4);
                        mem_values.push_back(registers[registerMap[mem_reg_buffer]]);
                        break;
                    case 7: // lw
    ...
    void printRegisters(int clockCycle) {
        ...
        std::cout << mem_keys.size() << ' ';
        for (int i = 0; i < mem_keys.size(); ++i)
            std::cout << mem_keys[i] << ' '<< mem_values[i] << ' ';
        std::cout << '\n';
    }
